...
import { useGetAllDeletedPostsQuery } from "@/redux/api/postsApi";
...
const DeletedContent = () => {
  ...
  const { data, isLoading } = useGetAllDeletedPostsQuery(category);
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center gap-10 sticky top-[81px] border-b z-30 bg-white p-3">
        ...
        <h3 className="font-semibold">Deleted Content {posts.length}</h3>
      </div>
      {/* PostCard */}
